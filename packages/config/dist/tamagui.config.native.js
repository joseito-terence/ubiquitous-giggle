...
var import_tamagui = require("tamagui"), import_font_inter = require("@tamagui/font-inter"), import_shorthands = require("@tamagui/shorthands"), import_v2 = require("@tamagui/themes/v2"), import_v2_themes = require("@tamagui/themes/v2-themes"), import_react_native_media_driver = require("@tamagui/react-native-media-driver"), import_animations = require("@my/ui/src/animations"), headingFont = (0, import_font_inter.createInterFont)({
  size: {
    6: 15
  },
  transform: {
