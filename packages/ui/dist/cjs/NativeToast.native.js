...
var import_jsx_runtime = require("react/jsx-runtime"), import_toast = require("@tamagui/toast"), import_tamagui = require("tamagui"), NativeToast = function() {
  var currentToast = (0, import_toast.useToastState)();
  return !currentToast || currentToast.isHandledNatively ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_toast.Toast, {
